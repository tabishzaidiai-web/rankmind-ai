...
const AGENTS = [
  {
    ...
    description: 'Deep crawls your website, scores 20+ SEO factors, and creates a prioritized action plan.',
    color: '#7c3aed',
  ...
  },
  {
    ...
    description: 'Finds real DA 40+ websites, writes guest posts, sends outreach emails automatically.',
    color: '#0d9488',
