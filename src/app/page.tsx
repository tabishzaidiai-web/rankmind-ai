      ...
      <section className="py-12 px-6 border-y border-white/5">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            { value: '10', label: 'SEO Factors Scored' },
            { value: 'Flash', label: 'Sale — From $5/mo' },
            { value: 'Dubai', label: 'UAE · Arabian AI Lab' },
          ].map((stat) => (
            <div key={stat.label}>
        ...
        <p className="text-center text-white/25 text-xs mt-4">Early access — flash sale pricing locked in for founding members.</p>
      </section>
